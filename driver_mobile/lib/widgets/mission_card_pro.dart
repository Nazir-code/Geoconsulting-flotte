...
class MissionCardPro extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final String status = _normalizeStatus(mission['status'] as String?);
    final String priority = mission['priority'] ?? 'medium';
    final bool hasActions = onStart != null || onComplete != null || onCancel != null;
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          mission['location'] ?? 'Destination non définie',
